...
export class Logger {
  ...
  createLogger() {
    ...
    if (process.env.NODE_ENV === 'production' && this.config.logFile) {
      transports.push(
  ...
  createSecurityLogger() {
    ...
    // Add dedicated security audit file in production
    if (process.env.NODE_ENV === 'production' && this.config.securityLogFile) {
      transports.push(
        new winston.transports.File({
