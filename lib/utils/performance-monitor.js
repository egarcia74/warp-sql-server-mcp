...
/**
 * Summarize a query metric for getQueryStats. `rowCount` is included only when
 * it was actually recorded, so an unknown count is omitted rather than shown as
 * 0 or an undefined placeholder (#1101).
