  ...
  recordQuery(queryData) {
    ...
    const queryMetric = {
      ...
      query: queryData.query
        ? queryData.query.length > 200
          ? `${queryData.query.substring(0, 200)}...`
          : queryData.query
        : 'unknown',
      database: queryData.database || 'default',
      startTime: queryData.timestamp ? queryData.timestamp.getTime() : Date.now(),
      ...
      rowCount: queryData.recordset ? queryData.recordset.length : 0
    };
