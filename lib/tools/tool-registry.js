...
const CONNECTION_TOOLS = [
  {
    name: 'connect',
    description: 'Establishes and verifies a connection to a specific database.',
    inputSchema: {
      type: 'object',
      properties: {
        database: {
          type: 'string',
          description:
            'The name of the database to connect to. If not provided, connects to the default database.',
          default: 'master'
        }
      }
    }
