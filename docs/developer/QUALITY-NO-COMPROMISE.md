...
> [Testing Guide](TESTING-GUIDE.md) and [`test/README.md`](../../test/README.md): 1,348 tests
> (1,281 unit, 27 Vitest integration, 40 live-database) across 53 tracked markdown files.
>
