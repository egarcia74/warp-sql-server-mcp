...
> [Testing Guide](TESTING-GUIDE.md) and [`test/README.md`](../../test/README.md): 1,290 tests
> (1,223 unit, 27 Vitest integration, 40 live-database) across 53 tracked markdown files.
>
