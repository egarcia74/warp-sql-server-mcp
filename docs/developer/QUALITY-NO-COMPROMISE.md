...
> [Testing Guide](TESTING-GUIDE.md) and [`test/README.md`](../../test/README.md): 1,141 tests
> (1,074 unit, 27 Vitest integration, 40 live-database) across 55 tracked markdown files.
>
