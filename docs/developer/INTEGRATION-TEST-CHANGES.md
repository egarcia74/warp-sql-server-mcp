...
> [`WARP.md`](../../WARP.md). Today's totals are 1,168 tests - 1,101 unit, 27 Vitest integration and
...
```text
test/
├── unit/                              # Automated unit tests (535+ at the time; 1,101 today)
├── integration/
...
- **Unit tests** (535+ then, 1,101 now): Fast, mocked, always run
