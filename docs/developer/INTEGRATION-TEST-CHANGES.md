...
> [`WARP.md`](../../WARP.md). Today's totals are 1,172 tests - 1,105 unit, 27 Vitest integration and
...
```text
test/
├── unit/                              # Automated unit tests (535+ at the time; 1,105 today)
├── integration/
...
- **Unit tests** (535+ then, 1,105 now): Fast, mocked, always run
