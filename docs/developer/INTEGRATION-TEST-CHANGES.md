...
> [`WARP.md`](../../WARP.md). Today's totals are 1,182 tests - 1,115 unit, 27 Vitest integration and
...
```text
test/
├── unit/                              # Automated unit tests (535+ at the time; 1,115 today)
├── integration/
...
- **Unit tests** (535+ then, 1,115 now): Fast, mocked, always run
