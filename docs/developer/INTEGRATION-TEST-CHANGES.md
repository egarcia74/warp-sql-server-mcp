...
> [`WARP.md`](../../WARP.md). Today's totals are 1,141 tests - 1,074 unit, 27 Vitest integration and
...
```text
test/
├── unit/                              # Automated unit tests (535+ at the time; 1,074 today)
├── integration/
...
- **Unit tests** (535+ then, 1,074 now): Fast, mocked, always run
