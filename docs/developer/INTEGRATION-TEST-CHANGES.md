...
> [`WARP.md`](../../WARP.md). Today's totals are 1,164 tests - 1,097 unit, 27 Vitest integration and
...
```text
test/
├── unit/                              # Automated unit tests (535+ at the time; 1,097 today)
├── integration/
...
- **Unit tests** (535+ then, 1,097 now): Fast, mocked, always run
