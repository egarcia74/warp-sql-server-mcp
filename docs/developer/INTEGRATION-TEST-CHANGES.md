...
> [`WARP.md`](../../WARP.md). Today's totals are 1,173 tests - 1,106 unit, 27 Vitest integration and
...
```text
test/
├── unit/                              # Automated unit tests (535+ at the time; 1,106 today)
├── integration/
...
- **Unit tests** (535+ then, 1,106 now): Fast, mocked, always run
