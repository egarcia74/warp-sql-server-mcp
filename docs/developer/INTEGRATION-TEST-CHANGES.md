...
> [`WARP.md`](../../WARP.md). Today's totals are 1,189 tests - 1,122 unit, 27 Vitest integration and
...
```text
test/
├── unit/                              # Automated unit tests (535+ at the time; 1,122 today)
├── integration/
...
- **Unit tests** (535+ then, 1,122 now): Fast, mocked, always run
