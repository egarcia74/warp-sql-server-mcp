...
> [`WARP.md`](../../WARP.md). Today's totals are 1,183 tests - 1,116 unit, 27 Vitest integration and
...
```text
test/
├── unit/                              # Automated unit tests (535+ at the time; 1,116 today)
├── integration/
...
- **Unit tests** (535+ then, 1,116 now): Fast, mocked, always run
