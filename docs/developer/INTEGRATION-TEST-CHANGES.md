...
> [`WARP.md`](../../WARP.md). Today's totals are 1,180 tests - 1,113 unit, 27 Vitest integration and
...
```text
test/
├── unit/                              # Automated unit tests (535+ at the time; 1,113 today)
├── integration/
...
- **Unit tests** (535+ then, 1,113 now): Fast, mocked, always run
