...
> [`WARP.md`](../../WARP.md). Today's totals are 1,348 tests - 1,281 unit, 27 Vitest integration and
...
```text
test/
├── unit/                              # Automated unit tests (535+ at the time; 1,281 today)
├── integration/
...
- **Unit tests** (535+ then, 1,281 now): Fast, mocked, always run
