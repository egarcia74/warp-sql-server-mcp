...
> [`WARP.md`](../../WARP.md). Today's totals are 1,197 tests - 1,130 unit, 27 Vitest integration and
...
```text
test/
├── unit/                              # Automated unit tests (535+ at the time; 1,130 today)
├── integration/
...
- **Unit tests** (535+ then, 1,130 now): Fast, mocked, always run
