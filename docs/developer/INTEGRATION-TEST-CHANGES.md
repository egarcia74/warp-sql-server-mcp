...
> [`WARP.md`](../../WARP.md). Today's totals are 1,290 tests - 1,223 unit, 27 Vitest integration and
...
```text
test/
├── unit/                              # Automated unit tests (535+ at the time; 1,223 today)
├── integration/
...
- **Unit tests** (535+ then, 1,223 now): Fast, mocked, always run
