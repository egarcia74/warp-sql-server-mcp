...
> [`WARP.md`](../../WARP.md). Today's totals are 1,166 tests - 1,099 unit, 27 Vitest integration and
...
```text
test/
├── unit/                              # Automated unit tests (535+ at the time; 1,099 today)
├── integration/
...
- **Unit tests** (535+ then, 1,099 now): Fast, mocked, always run
