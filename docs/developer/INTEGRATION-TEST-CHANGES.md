...
> [`WARP.md`](../../WARP.md). Today's totals are 1,161 tests - 1,094 unit, 27 Vitest integration and
...
```text
test/
├── unit/                              # Automated unit tests (535+ at the time; 1,094 today)
├── integration/
...
- **Unit tests** (535+ then, 1,094 now): Fast, mocked, always run
