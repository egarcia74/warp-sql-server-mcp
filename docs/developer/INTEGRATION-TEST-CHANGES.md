...
> [`WARP.md`](../../WARP.md). Today's totals are 1,177 tests - 1,110 unit, 27 Vitest integration and
...
```text
test/
├── unit/                              # Automated unit tests (535+ at the time; 1,110 today)
├── integration/
...
- **Unit tests** (535+ then, 1,110 now): Fast, mocked, always run
