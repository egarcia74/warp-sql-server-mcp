...
> [`WARP.md`](../../WARP.md). Today's totals are 1,185 tests - 1,118 unit, 27 Vitest integration and
...
```text
test/
├── unit/                              # Automated unit tests (535+ at the time; 1,118 today)
├── integration/
...
- **Unit tests** (535+ then, 1,118 now): Fast, mocked, always run
