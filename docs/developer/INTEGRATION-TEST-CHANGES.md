...
> [`WARP.md`](../../WARP.md). Today's totals are 1,174 tests - 1,107 unit, 27 Vitest integration and
...
```text
test/
├── unit/                              # Automated unit tests (535+ at the time; 1,107 today)
├── integration/
...
- **Unit tests** (535+ then, 1,107 now): Fast, mocked, always run
