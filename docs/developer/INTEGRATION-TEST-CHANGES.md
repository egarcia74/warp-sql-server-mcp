...
> [`WARP.md`](../../WARP.md). Today's totals are 1,346 tests - 1,279 unit, 27 Vitest integration and
...
```text
test/
├── unit/                              # Automated unit tests (535+ at the time; 1,279 today)
├── integration/
...
- **Unit tests** (535+ then, 1,279 now): Fast, mocked, always run
