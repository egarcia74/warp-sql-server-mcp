...
During intensive testing sessions (like our comprehensive 1,103-test unit suite), Node.js/Vitest processes can sometimes become orphaned and consume significant system resources:
