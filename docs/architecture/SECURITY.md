...
> selects 55 of 1,279 tests and **zero** from `sql-batch-guard`, `where-clause-guard`,
...
> runs the whole directory - all 1,279 tests. Call `npx vitest run <paths>` directly. Same
