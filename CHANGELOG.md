...
- Added a static guard test enforcing that caller-controlled values reach SQL only through approved escapers,
  preventing the injection class fixed in 1.7.16–1.7.18 from recurring
