...
- **Total Tests**: 1,471 - **every one of them runs automatically on every pull request**
  - 1,404 unit tests (`npm run test:unit`, 32 files, mocked)
...
| ------------------------------------------ | --------------- | -------------------------------------- | ------------------------------------------ |
| `test/unit/**`                             | 1,404           | `npm run test:unit`                    | Yes - required `Tests (22)` / `(24)`       |
...
The 1,404 unit tests are spread across 32 files. Grouped by area, the totals sum to 1,404:
...
| Infrastructure utilities        | 244   | `csv` (11), `performance-monitor` (84), `streaming-handler` (63), `logger` (52), `connection-manager` (34)                                                                                                                                                                                                  |
