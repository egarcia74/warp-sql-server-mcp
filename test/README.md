...
- **Total Tests**: 1,686 - **every one of them runs automatically on every pull request**
  - 1,619 unit tests (`npm run test:unit`, 36 files, mocked)
...
| ------------------------------------------ | --------------- | -------------------------------------- | ------------------------------------------ |
| `test/unit/**`                             | 1,619           | `npm run test:unit`                    | Yes - required `Tests (22)` / `(24)`       |
...
The 1,619 unit tests are spread across 36 files. Grouped by area, the totals sum to 1,619:
