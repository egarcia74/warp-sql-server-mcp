...
- **Total Tests**: 1,460 - **every one of them runs automatically on every pull request**
  - 1,393 unit tests (`npm run test:unit`, 31 files, mocked)
...
| ------------------------------------------ | --------------- | -------------------------------------- | ------------------------------------------ |
| `test/unit/**`                             | 1,393           | `npm run test:unit`                    | Yes - required `Tests (22)` / `(24)`       |
...
The 1,393 unit tests are spread across 31 files. Grouped by area, the totals sum to 1,393:
...
| Infrastructure utilities        | 233   | `performance-monitor` (84), `streaming-handler` (63), `logger` (52), `connection-manager` (34)                                                                                                                                                                                                              |
