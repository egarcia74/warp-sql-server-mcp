...
- **Total Tests**: 1,682 - **every one of them runs automatically on every pull request**
  - 1,615 unit tests (`npm run test:unit`, 36 files, mocked)
...
| ------------------------------------------ | --------------- | -------------------------------------- | ------------------------------------------ |
| `test/unit/**`                             | 1,615           | `npm run test:unit`                    | Yes - required `Tests (22)` / `(24)`       |
...
The 1,615 unit tests are spread across 36 files. Grouped by area, the totals sum to 1,615:
...
| Infrastructure utilities        | 253   | `csv` (13), `result-formatter` (7), `performance-monitor` (84), `streaming-handler` (63), `logger` (52), `connection-manager` (34)                                                                                                                                                                                                                                                        |
